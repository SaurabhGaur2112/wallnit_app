...
import com.wallnit.wallnitlogin.WallnitCircleBackgroundUpdate.WallnitCircleColorImageThemeUpdate;

public class WallnitCircleBackgroundImageTheme extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    EditText image_edit;
    Session session;
    WallnitCircleColorImageThemeUpdate wallnitCircleColorImageThemeUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallnit_circle_background_image_theme);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);
        session = new Session(this);
        wallnitCircleColorImageThemeUpdate = new WallnitCircleColorImageThemeUpdate();

        image_edit = (EditText) findViewById(R.id.background_imagewrite_circle);

        img_theme1=(ImageView) findViewById(R.id.circle_imagetheme_first);
        img_theme_sel1=(ImageView) findViewById(R.id.circle_imagetheme_first_select);

        img_theme2=(ImageView) findViewById(R.id.circle_imagetheme_second);
        img_theme_sel2=(ImageView) findViewById(R.id.circle_imagetheme_second_select);

        img_theme3=(ImageView) findViewById(R.id.circle_imagetheme_third);
        img_theme_sel3=(ImageView) findViewById(R.id.circle_imagetheme_third_select);

        img_theme4=(ImageView) findViewById(R.id.circle_imagetheme_fourth);
        img_theme_sel4=(ImageView) findViewById(R.id.circle_imagetheme_fourth_select);

        img_theme5=(ImageView) findViewById(R.id.circle_imagetheme_fifth);
        img_theme_sel5=(ImageView) findViewById(R.id.circle_imagetheme_fifth_select);

        img_theme6=(ImageView) findViewById(R.id.circle_imagetheme_sixth);
        img_theme_sel6=(ImageView) findViewById(R.id.circle_imagetheme_sixth_select);

        img_theme7=(ImageView) findViewById(R.id.circle_imagetheme_seventh);
        img_theme_sel7=(ImageView) findViewById(R.id.circle_imagetheme_seventh_select);

        img_theme8=(ImageView) findViewById(R.id.circle_imagetheme_eighth);
        img_theme_sel8=(ImageView) findViewById(R.id.circle_imagetheme_eighth_select);

        img_theme9=(ImageView) findViewById(R.id.circle_imagetheme_ninth);
        img_theme_sel9=(ImageView) findViewById(R.id.circle_imagetheme_ninth_select);

        img_theme10=(ImageView) findViewById(R.id.circle_imagetheme_tenth);
        img_theme_sel10=(ImageView) findViewById(R.id.circle_imagetheme_tenth_select);

        img_theme11=(ImageView) findViewById(R.id.circle_imagetheme_eleventh);
        img_theme_sel11=(ImageView) findViewById(R.id.circle_imagetheme_eleventh_select);

        img_theme12=(ImageView) findViewById(R.id.circle_imagetheme_twelth);
        img_theme_sel12=(ImageView) findViewById(R.id.circle_imagetheme_twelth_select);

        img_theme13=(ImageView) findViewById(R.id.circle_imagetheme_thirteen);
        img_theme_sel13=(ImageView) findViewById(R.id.circle_imagetheme_thirteen_select);

        img_theme14=(ImageView) findViewById(R.id.circle_imagetheme_fourteen);
        img_theme_sel14=(ImageView) findViewById(R.id.circle_imagetheme_fourteen_select);

        img_theme15=(ImageView) findViewById(R.id.circle_imagetheme_fifteen);
        img_theme_sel15=(ImageView) findViewById(R.id.circle_imagetheme_fifteen_select);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.account_infochange)
        {
            ...
            {
                new ClassThemeChange(circleSessionid,imageGetTheme).execute();
            }
        }
    ...
    public class ClassThemeChange extends AsyncTask<Void,Void,Void>{

        String circleIdGet,themeGet;
        ProgressDialog progressDialog;

        public ClassThemeChange(String circleIdGet,String themeGet){
            this.circleIdGet = circleIdGet;
            this.themeGet = themeGet;
        }

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(WallnitCircleBackgroundImageTheme.this,"","Change background...",false,false);
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            startActivity(new Intent(WallnitCircleBackgroundImageTheme.this,WallnitCircleProfile.class));
            finish();
        }

        @Override
        protected Void doInBackground(Void... voids) {
            wallnitCircleColorImageThemeUpdate.circleColorThemeUpdate(circleIdGet,themeGet);
            return null;
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_circle_imgthemehome) {
            startActivity(new Intent(WallnitCircleBackgroundImageTheme.this,WallnitCircleProfile.class));
            finish();
        }  else if (id == R.id.nav_circle_imgthemecolor_theme) {
            startActivity(new Intent(WallnitCircleBackgroundImageTheme.this, WallnitCircleBackgroundOption.class));
            finish();
        }
