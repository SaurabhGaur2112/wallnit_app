 ...
 */
public class WallnitCircleUpdateEditBlogPost {
    ...
    public void updateEditBlogPost(String post_number,String editblogTitle,String editblogBody,String post_dateTime)
    {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.wallnit.com/wallnit_android/wallnit_android_circle_update_editblog_post.php");
