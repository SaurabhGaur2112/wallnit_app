 ...
 */
public class WallnitCircleGetEditBlogPost {
    ...
    public static String[] getvaluesEditPostNumber(String post_number)
    {
        ...
        loginEmailSend.add(new BasicNameValuePair("editblog_circle", post_number));

        try {
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost = new HttpPost("http://www.wallnit.com/wallnit_android/wallnit_android_circle_get_editblog_post.php");
