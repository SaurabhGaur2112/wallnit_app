 ...
 */
public class WallnitCircleAccountCirclenameGet {
    ...
    String temp = "";
    String[] arr;
    String circleGetCirclename;

    public String getCirclename(String circleid)
    {
        ...
        try {
            ...
            circleGetCirclename = Arrays.toString(arr).replace("[", "").replace("]", "");

        } catch (Exception e) {

        }
        return circleGetCirclename;
    }
}
