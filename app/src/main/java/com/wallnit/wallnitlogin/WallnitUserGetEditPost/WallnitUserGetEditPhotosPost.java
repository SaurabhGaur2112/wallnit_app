 ...
 */
public class WallnitUserGetEditPhotosPost {
    ...
    public static String[] getvaluesEditPostNumber(String post_number)
    {
        ...
        loginEmailSend.add(new BasicNameValuePair("editcaption", post_number));

        try {
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost = new HttpPost("http://www.wallnit.com/wallnit_android/wallnit_android_user_get_editphotos_post.php");
