 ...
 */
public class WallnitLoginUserCheckConfirmation {
    InputStream is = null;
    String line = null;
    String result = null;
    String temp = "";
    ...
    public String wallnitCheckConfirmation(String userid)
    {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.wallnit.com/wallnit_android/wallnit_android_login_user_confirmation.php");
