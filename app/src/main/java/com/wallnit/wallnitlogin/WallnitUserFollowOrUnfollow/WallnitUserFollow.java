 ...
 */
public class WallnitUserFollow {

    InputStream is = null;
    public void wallnitFollow(String userid,String otheruserid)
    {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.wallnit.com/wallnit_android/wallnit_android_user_follow.php");
