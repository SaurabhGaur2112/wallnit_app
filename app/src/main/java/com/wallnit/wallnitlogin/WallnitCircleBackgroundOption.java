...
public class WallnitCircleBackgroundOption extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallnit_circle_background_option);
        ...
        color_edit = (EditText) findViewById(R.id.background_colorwritecircle);

        clr_img1=(ImageView) findViewById(R.id.circle_color_first);
        clr_img_tick1=(ImageView) findViewById(R.id.circle_color_first_select);

        clr_img2=(ImageView) findViewById(R.id.circle_color_second);
        clr_img_tick2=(ImageView) findViewById(R.id.circle_color_second_select);

        clr_img3=(ImageView) findViewById(R.id.circle_color_third);
        clr_img_tick3=(ImageView) findViewById(R.id.circle_color_third_select);

        clr_img4=(ImageView) findViewById(R.id.circle_color_fourth);
        clr_img_tick4=(ImageView) findViewById(R.id.circle_color_fourth_select);

        clr_img5=(ImageView) findViewById(R.id.circle_color_fifth);
        clr_img_tick5=(ImageView) findViewById(R.id.circle_color_fifth_select);

        clr_img6=(ImageView) findViewById(R.id.circle_color_sixth);
        clr_img_tick6=(ImageView) findViewById(R.id.circle_color_sixth_select);

        clr_img7=(ImageView) findViewById(R.id.circle_color_seventh);
        clr_img_tick7=(ImageView) findViewById(R.id.circle_color_seventh_select);

        clr_img8=(ImageView) findViewById(R.id.circle_color_eighth);
        clr_img_tick8=(ImageView) findViewById(R.id.circle_color_eighth_select);

        clr_img9=(ImageView) findViewById(R.id.circle_color_ninth);
        clr_img_tick9=(ImageView) findViewById(R.id.circle_color_ninth_select);

        clr_img10=(ImageView) findViewById(R.id.circle_color_tenth);
        clr_img_tick10=(ImageView) findViewById(R.id.circle_color_tenth_select);

        clr_img11=(ImageView) findViewById(R.id.circle_color_eleventh);
        clr_img_tick11=(ImageView) findViewById(R.id.circle_color_eleventh_select);

        clr_img12=(ImageView) findViewById(R.id.circle_color_twelth);
        clr_img_tick12=(ImageView) findViewById(R.id.circle_color_twelth_select);

        clr_img13=(ImageView) findViewById(R.id.circle_color_thirteen);
        clr_img_tick13=(ImageView) findViewById(R.id.circle_color_thirteen_select);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.account_infochange)
        {
            ...
            {
                new CircleBackgroundColor(circleSessionid,colorGetTheme).execute();
            }
        }
    ...
    public class CircleBackgroundColor extends AsyncTask<Void,Void,Void>{

        String circleidGet,colorGet;
        ProgressDialog progressDialog;

        public CircleBackgroundColor(String circleidGet,String colorGet){
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(WallnitCircleBackgroundOption.this,"","Change background...",false,false);
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            startActivity(new Intent(WallnitCircleBackgroundOption.this,WallnitCircleProfile.class));
            finish();
        }

        @Override
        protected Void doInBackground(Void... voids) {
            wallnitCircleColorImageThemeUpdate.circleColorThemeUpdate(circleidGet,colorGet);
            return null;
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_circle_colorhome) {
            startActivity(new Intent(WallnitCircleBackgroundOption.this,WallnitCircleProfile.class));
            finish();
        } else if (id == R.id.nav_circle_colorimage_theme) {
            startActivity(new Intent(WallnitCircleBackgroundOption.this,WallnitCircleBackgroundImageTheme.class));
            finish();
