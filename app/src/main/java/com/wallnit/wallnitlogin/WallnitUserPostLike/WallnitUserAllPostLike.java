 ...
 */
public class WallnitUserAllPostLike {

    InputStream is = null;

    public void userPostLike(String postNumber,String userOwnId)
    {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.wallnit.com/wallnit_android/wallnit_android_user_post_like.php");
