 ...
 */
public class WallnitUserSignupUserId {
    ...
    public String getSignupUserId(String email)
    {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.wallnit.com/wallnit_android/wallnit_android_signupuserid.php");
